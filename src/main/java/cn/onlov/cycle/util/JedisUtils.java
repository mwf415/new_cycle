...
//    private static String host = ConfigUtils.getProperty("spring.redis.host", "127.0.0.1");
            ...
            synchronized (this.getClass()) {
                if (jedisPool == null) {
                    try {
                        ...
                        if (StringUtils.isBlank(password)) { // redis未设置了密码
        ...
        while (true) // 如果是网络超时则多试几次
        {
            try {
                ...
                if (e instanceof JedisConnectionException || e instanceof SocketTimeoutException) {
                    ...
                    log.error("jedisInfo NumActive=" + getJedisPool().getNumActive() + ", NumIdle=" + getJedisPool().getNumIdle()
                            + ", NumWaiters=" + getJedisPool().getNumWaiters() + ", isClosed=" + getJedisPool().isClosed());
                    log.error("redis异常", e);
                    break;
                }
            }
    ...
    public void returnJedis(Jedis jedis) {
        if(getJedisPool()!=null && jedis!=null) {
